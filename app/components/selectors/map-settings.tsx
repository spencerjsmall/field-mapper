...
export function MapSettings({
  ...
  return (
    <ul className="menu menu-horizontal bg-gray-800 rounded-box border border-gray-600 drop-shadow-sm">
      <li tabIndex={0}>
        ...
        {basemapMenu && (
          <ul className="rounded-box bg-gray-800 border border-gray-600 drop-shadow-sm">
            <li
